/**
 * @file matrix_mult_tiling_optimized_1_double.cu
 * 
 * CUDA code to calculate D = A*B (tiling algorithm avoid bank conflict and additional optimization, double precision)
 * 
 */
...
/** Main entry point.
 * Computes matrix multiplication using optimized tiling algorithm (double precision)
 */
__global__ void matrix_mult_tiling_optimization_1_double( 
                      double * D, 
                      double * A, 
                      double * B, 
