/**
 * @file mattrix_mult_tiling_optimization_2_single.cu
 * 
 * CUDA code to calculate D = A*B (optimization 2 adding loop unroll)
 * 
 */
...
/** Main entry point.
 * Kernel for matrix multiplication adding loop unroll on top of optimization 1.
 */
__global__ void matrix_mult_tiling_optimization_2_single( 
                      float * D, 
                      float * A, 
                      float * B, 
