/**
 * @file matrix_mult_naive_double.cu
 *
 * CUDA code to calculate D = A*B using a naive algorithm (double precision)
 *
 */


/** Main entry point.
 * Implements naive double precision matrix multiplication
 */
__global__ void matrix_mult_naive_double(
                      double * D,
                      const double * A,
                      const double * B,
